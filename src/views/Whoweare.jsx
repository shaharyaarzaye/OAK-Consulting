  ...
  return (
    <div id="scroll-container" className="bg-white">
      ...
      >
        <div className="flex flex-col items-center p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-20 px-10 ">
            {/* Cards 1-4 */}
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-500 text-3xl flex-shrink-0 mr-4 pt-1"><IconEye stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-bold text-gray-900 mb-2">Enhanced Brand Visibility</h3><p className=" text-justify">We amplify your brand across digital and traditional channels, ensuring it reaches the right audience at the right time.</p></div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-500 text-3xl flex-shrink-0 mr-4 pt-1"><IconTrendingUp stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-bold text-gray-900 mb-2">Business Growth & Sales</h3><p className=" text-justify">Our integrated PR and marketing strategy drive engagement, generate leads and convert visibility into tangible business results.</p></div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-500 text-3xl flex-shrink-0 mr-4 pt-1"><IconSpeakerphone stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-bold text-gray-900 mb-2">Greater Brand Awareness</h3><p className=" text-justify">Targeted campaigns and storytelling initiatives increase awareness, helping your audience recognize and remember your brand.</p></div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-500 text-3xl flex-shrink-0 mr-4 pt-1"><IconShieldHalfFilled stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-bold text-gray-900 mb-2">Sustained Positive Reputation</h3><p className=" text-justify">Through proactive reputation management and strategic communications, we help maintain a trustworthy and respected brand image.</p></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div 
        ...
        className="h-screen flex flex-col justify-center items-center py-10"
      >
        <div className="px-10 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start text-left shadow-md hover:shadow-xl transition duration-300">
              ...
              <div><h3 className="text-xl font-semibold text-gray-900 mb-2">In-Depth Market Knowledge</h3><p className="text-gray-600 text-justify">Expertise across the Middle East, Africa, and India.</p></div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start text-left shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-500 text-4xl mr-4 mt-1"><IconIkosaedr stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-semibold text-gray-900 mb-2">Structured Work Processes</h3><p className="text-gray-600 text-justify">Methodical approaches that ensure efficiency and effectiveness.</p></div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start text-left shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-500 text-4xl mr-4 mt-1"><IconBulb stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-semibold text-gray-900 mb-2">Proactive Attitude</h3><p className="text-gray-600 text-justify">Always anticipating challenges and opportunities.</p></div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start text-left shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-500 text-4xl mr-4 mt-1"><IconBrandWechat stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-semibold text-gray-900 mb-2">Communication Strategy</h3><p className="text-gray-600 text-justify">Tailored to your brand’s objectives and marketing goals.</p></div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start text-left shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-600 text-4xl mr-4 mt-1"><IconArrowRampRight stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-semibold text-gray-900 mb-2">Flexibility</h3><p className="text-gray-600 text-justify">Adapting seamlessly to evolving client needs.</p></div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start text-left shadow-md hover:shadow-xl transition duration-300">
              <div className="text-orange-500 text-4xl mr-4 mt-1"><IconHeartHandshake stroke={2} size={30} /></div>
              <div><h3 className="text-xl font-semibold text-gray-900 mb-2">Strong Media Relationships</h3><p className="text-gray-600 text-justify">Leveraging our trusted connections to benefits.</p></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div 
        ...
        className="h-screen flex flex-col justify-center items-center bg-cover bg-center py-10 px-4 sm:px-6 lg:px-8"
      >
        <div className="relative z-10 text-center text-black p-10 max-w-4xl">
