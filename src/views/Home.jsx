    ...
    <div>
      ...
      <div className="md:h-screen flex  flex-col items-center justify-center">
        <div>
          ...
          <p className="text-center md:px-25 px-10 text-xl  mt-10 ">
          ...
          <p className="text-center md:px-25 px-10 text-xl py-4 mb-10 ">
      ...
      <div className="md:h-screen flex flex-col items-center justify-center">
        <div className="bg-white py-16 px-6 md:px-20 border-t border-t-zinc-400 w-full h-full flex flex-col justify-center items-center">
          {/* --- OUR MOTTO SECTION --- */}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            {mottoItems.map((item, index) => (
              <div
                ...
                className="p-6 flex flex-col justify-between bg-white/5 backdrop-blur-sm rounded-xl border border-black/30 text-black transition duration-300 hover:bg-white/10"
              >
      ...
      <div>
        <div className=" border-t-zinc-400   border-t">
          <h2
            className={`md:text-4xl text-2xl font-bold text-center pt-8  text-black`}
          >
